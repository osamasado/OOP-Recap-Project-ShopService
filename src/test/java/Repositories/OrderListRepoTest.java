...
class OrderListRepoTest {
    ...
    void getAllOrders_shouldReturnAllAddedOrders_whenCalledWithTwoAddedOrders() {
        ...
        Order order1 = new Order("1", Instant.now(), 1, List.of(product1, product2), 100,15, OrderStatus.IN_PROCESSING);

        Product product3 = new Product("1", "Laptop", "HP Laptop 2026",100, 1);
        Product product4 = new Product("2", "Maus", "Wireless Maus",10, 1);

        Order order2 = new Order("2", Instant.now(), 2, List.of(product3, product4), 110,2, OrderStatus.IN_PROCESSING);
    ...
    void addOrder_shouldAddOrderToRepo_whenCalledWithOneAddedOrder() {
        ...
        Order order = new Order("1", Instant.now(), 1, List.of(product1, product2), 100,15, OrderStatus.IN_PROCESSING);
